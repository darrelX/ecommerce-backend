...
let UserController = class UserController {
    ...
    async getUsers(skip, take, cursor, where, orderBy, page = '1') {
        const params = {
    ...
    async createUser(userData) {
        try {
            const userDto = (0, class_transformer_1.plainToClass)(create_user_dto_1.CreateUserDto, userData);
            await (0, class_validator_1.validateOrReject)(userDto);
